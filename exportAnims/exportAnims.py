...
if len(sys.argv) < 3:
    sys.stderr.write("Usage: exportAnims.py <maya_file> <output_folder>\n")
    sys.exit(1)

maya_file = sys.argv[1]
output_folder = sys.argv[2]

# Set necessary Maya environment variables
os.environ['MAYA_DISABLE_CLICKTONE'] = '1'
# Removed unnecessary QTWEBENGINE_DISABLE_SANDBOX and PySide2 imports
